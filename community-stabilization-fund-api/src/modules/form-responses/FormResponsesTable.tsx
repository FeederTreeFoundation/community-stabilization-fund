...
const createTableColumn = (content: string) => {
    return (
        <th>{content}</th>
	)
};
const createTableData = (content: string) => {
    return (
        <td>{content}</td>
	)
}
        ...
        <table>
            <tr>
                {formResponseQuestions.map(
                    string => createTableColumn(string)
                )}
            </tr>
            <tr>
                {Object.values(mockData).map(
                    string => createTableData(string)
                )}
            </tr>
            </table>
	);
